...
export const HeroSection = () => {
  ...
  return <section id="inicio" className="min-h-screen gradient-hero pt-20 lg:pt-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button onClick={() => scrollToSection("#contato")} className="bg-primary hover:bg-coral-dark text-primary-foreground rounded-full px-8 py-6 text-base">
                Agende sua Consulta
              </Button>
              <Button variant="outline" onClick={() => scrollToSection("#sobre")} className="border-primary text-primary hover:bg-primary hover:text-primary-foreground rounded-full px-8 py-6 text-base">
                Conheça-me
              </Button>
            </div>
          </div>
